   ...
   #+BEGIN_SRC emacs-lisp
     (use-package flycheck
       ...
       (defun ds/kill-flycheck-popup ()
         (let ((errwindow (get-buffer-window flycheck-error-list-buffer)))
               (if errwindow (quit-window 'bury errwindow))))
       ...
       (defun ds/flycheck-close-unused-list (&rest _)
         (if (and (not flycheck-enabled-checkers)
                  (bufferp flycheck-error-list-buffer))
             (ds/kill-flycheck-popup)))
  
       (add-function :after (symbol-function 'switch-to-buffer) #'ds/flycheck-close-unused-list)
       (add-function :after (symbol-function 'other-window) #'ds/flycheck-close-unused-list)
       (add-function :after (symbol-function 'ace-select-window) #'ds/flycheck-close-unused-list)
