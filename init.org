...
** Zenburn
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (with-eval-after-load 'ivy
         (zenburn-with-color-variables
           (set-face-attribute 'ivy-current-match nil :foreground zenburn-bg-2 :background zenburn-bg+3 :box zenburn-blue :underline nil)
           (set-face-attribute 'ivy-subdir nil :foreground zenburn-blue-1 :weight 'bold)
...
* Bootstrap
  ...
  ;; eval: (when (fboundp 'ds/toggle-serif) (ds/toggle-serif))
  ;; End:
