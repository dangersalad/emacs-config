                         ...
                         (:eval
                          (let* ((active (powerline-selected-window-active))
                                 ...
                                 (lhs (append
                                       ...
                                       (when tramp-ssh (ds/powerline-arrow-tag-left powerline-flycheck-info powerline-raw " SSH "))
                                       (when tramp-sudo (ds/powerline-arrow-tag-left powerline-flycheck-error powerline-raw " SUDO "))
                                       (when tramp-su (ds/powerline-arrow-tag-left powerline-flycheck-warning powerline-raw " SU "))
                                       (list (funcall separator-left mode-line flycheck-face powerline-height)
